            ...
            <div className="col-md-10 offset-md-1">
                <div className="contact_inner">
                        ...
                        <div className="col-lg-8 col-md-7">
                            <div className="contact_form_inner">
                                <div className="contact_field">
                                    ...
                                    <input type="text" className="form-control form-group" placeholder="Email" />
                                    <textarea className="form-control form-group" placeholder="Message"></textarea>
                                    <button className="btn btn-primary contact_form_submit">Send</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-5">
                            <div className="right_contact_social_icon d-flex align-items-end">
                                <ul className="social_item_inner d-flex list-unstyled mb-0">
                                    <li><a href="#"><i className="fab fa-facebook-square"></i></a></li>
                                    <li><a href="#"><i className="fab fa-instagram"></i></a></li>
                                    <li><a href="#"><i className="fab fa-twitter"></i></a></li>
                                </ul>
                    ...
                    <div className="contact_info_sec mt-4">
                        <h4>Contact Info</h4>
                        <div className="d-flex info_single align-items-center mb-2">
